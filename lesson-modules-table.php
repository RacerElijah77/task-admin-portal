<?php
    ...
    $query_view_table = "SELECT * FROM lessonModules";
    ...
    <body style="background-color: white;" id="page-top">
             ...
             <div class = "position-relative">
                 <div class="position-absolute top-0 start-50 translate-middle-x">
                     <div class = "card shadow rounded text-bg-dark mb-3 text-center m-3" style="max-width:200rem; min-width: 75rem;">
                        <h1 class= "mt-4" >TASK Lesson Module Management</h1>
                        <hr>
                        <p class = "p-4">This page will be responsible for the maintenece of the Lesson Learning modules for TASK. The following table will allow you to add, view, delete, and edit module information in regards to title
                            and description. Additionally, the admin can add more information pertaining to each module for each new page added in the web application; the number of pages can be determined by admin.
                        </p>
                        <p class = "p-1">
                            PLEASE NOTE: Deletion of a module will also delete the associated quiz and quiz question(s). Please ensure that you want to do this operation.
                        </p>
                    ...
                    <div class = "container text-center">
                        <button type="button" class="btn btn-success m-1" data-bs-toggle="modal" data-bs-target="#addScreenModal">Add Module</button>
                        <a href="lesson-module-page-table.php"><button type="button" class="btn btn-warning m-1">Manage Module Page Content</button></a>
                    ...
                    <div class = "mt-5 table-responsive" style="max-width:100rem;" id = "link_wrapper">
                        ...
                        <table id="modules_table" class = "table stripe">
                            <thead>
                                <tr>
                                    <th scope="col">Module ID</th>
                                    <th scope="col">Module Name</th>
                                    <th scope="col">Module Summary</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <td style="max-width: 20rem; "><div style="white-space: nowrap; overflow-x: hidden;"><?php echo $row['module_summary']; ?></div></td>
                                    <td><?php echo $row['module_image']; ?></td>
                                    <td><?php echo $row['date_created']; ?></td>
                                    <td>
                                        <a href="table_operations/lesson-modules-view.php?id=<?= $row['module_id']; ?>" class="btn btn-sm"><i class="fa-solid fa-eye"></i></a>
                                        <a href="table_operations/lesson-modules-edit.php?id=<?= $row['module_id']; ?>" class="btn btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="php/lesson_module_db_operations.php" method="POST" enctype="multipart/form-data" >
                            <div class="mb-3">
                                ...
                                <input type="text" name="module_name" id="module_name" class="form-control" placeholder="Food Hunger" required>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <label for="module_summary" class="form-label">Module Summary</label>
                                <textarea class="form-control" name="module_summary" id="module_summary" required></textarea>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="."><button type="submit" name = "add_module" class="btn btn-primary">Add Module</button></a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            ...
                            will also delete all associated <strong>quiz content with this module. </strong>
                        </p>
                    ...
                    <form action= "php/lesson_module_db_operations.php" method ="POST" class="d-inline" enctype="multipart/form-data">
                        <div class ="p-3">
        ...
        <script>
            $('#confirmationDeletionModal').on('show.bs.modal', function(event){
                ...
                modal.find('#module_id').val(getID);
