...
<html>
    <head>
        ...
        <title>TASK Users (Students) - View</title>
    ...
    <body style="background-color: white;" id="page-top">
        ...
        <div id="wrapper">
            ...
            <div class="container justify-content-center centered w-50">
                ...
                <h2>User (Student) Information</h2>
                ...
                if(isset($_GET['id'])) {
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        ?>
                            <div class="mb-3">
                                <h5>User (Student) Email</h5>
                                <p><?=$selectedUser['user_email']?></p>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>First Name</h5>
                                <p><?=$selectedUser['user_first_name']?></p>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>Last Name</h5>
                                <p><?=$selectedUser['user_last_name']?></p>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <h5># of Lesson Modules Completed</h5>
                                <p><?=$selectedUser['number_completed_modules']?></p>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>Date Created</h5>
                                <p><?=$selectedUser['date_created']?></p>
                                <!-- <div class="form-text">Lesson Module Name</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>Last Login (PWA) </h5>
