...
<html>
    <head>
        ...
        <title>TASK Quiz Question - View</title>
    ...
    <body style="background-color: white;" id="page-top">
        ...
        <div id="wrapper">
            ...
            <div class="container justify-content-center centered w-50">
                ...
                <h2>View Selected Quiz Question Information</h2>
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        ?>
                            ...
                            <div class="mb-3">
                                ...
                                <p><?=$selectedQuizQuestion['quiz_question_text']?></p>
                                <!-- <div class="form-text">Lesson Module Summary</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>Question Number</h5>
                                <p><?=$selectedQuizQuestion['question_no']?></p>
                                <!-- <div class="form-text">Lesson Module Summary</div> -->
                            </div>
                            <div class="mb-3">
                                <h5>Question Points</h5>
                                <p><?=$selectedQuizQuestion['question_points']?></p>
                                <!-- <div class="form-text">Lesson Module Summary</div> -->
                            </div>
