...
<html>
    <head>
        ...
        <title>TASK Users (Students) - Edit</title>
            ...
            <div class="container justify-content-center centered w-50">
                ...
                if(isset($_GET['id'])) {
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        $selectedUser = mysqli_fetch_array($query_run);
                        ...
                        ?>
                            <form action="../php/users_db_operations.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="user_email" id="user_email" class="form-control" value="<?=$selectedUser['user_email']?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="user_first_name" class="form-label">First Name</label>
                                    <input type="text" name="user_first_name" id="user_first_name" class="form-control" value="<?=$selectedUser['user_first_name']?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="user_last_name" class="form-label">Last Name</label>
                                    <input type="text" name="user_last_name" id="user_last_name" class="form-control" value="<?=$selectedUser['user_last_name']?>" required>
                                </div>

                                <div class="modal-footer">
                                    <a href="../users-table.php" class="btn btn-secondary" role="button">Close</a>
